...
export type VotingEscrowLocksQuery = { __typename?: 'Query', votingEscrowLocks: Array<{ __typename?: 'VotingEscrowLock', id: string, lockedBalance: any }> };


export const VotingEscrowLocksDocument = gql`
    query VotingEscrowLocks($blockNumber: Int!) {
  votingEscrowLocks(
    first: 1000
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    VotingEscrowLocks(variables: VotingEscrowLocksQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<VotingEscrowLocksQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<VotingEscrowLocksQuery>(VotingEscrowLocksDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'VotingEscrowLocks', 'query');
    }
  };
}
