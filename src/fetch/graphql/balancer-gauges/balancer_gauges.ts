...
export type VotingEscrowsQueryVariables = Exact<{
  blockNumber: Scalars['Int'];
  locksSkip: Scalars['Int'];
  locksLimit: Scalars['Int'];
}>;


export type VotingEscrowsQuery = { __typename?: 'Query', votingEscrows: Array<{ __typename?: 'VotingEscrow', id: string, stakedSupply: any, locks?: Array<{ __typename?: 'VotingEscrowLock', id: string, lockedBalance: any }> | null }> };


export const VotingEscrowsDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    VotingEscrows(variables: VotingEscrowsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<VotingEscrowsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<VotingEscrowsQuery>(VotingEscrowsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'VotingEscrows', 'query');
    }
  };
}
